...
Monitoring  XenServer VMs Using Nagios
**************************************
...
NOTE: HERE infics is my nagios server hostname so i renamed localhost_nagios2.cfg to infics.cfg file and properly replace the hostname as shown below:

infics_cfg_initial JPG
...
Place the script check_bandwidth to path /usr/lib/nagios/plugins/
...
wget_testing_cloud_image JPG


After approximately 4-5 mins in the browser i was able to observe the CRITICAL status for CHECK-BANDWIDTH as shown below:
Nagios_and_client_services_critical JPG




YET TO START: Configuring Email Notifications - CRITICAL / SMS messages WARNING
===============================================================================
